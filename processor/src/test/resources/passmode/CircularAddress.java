...
public final class CircularAddress implements CircularAddressSpec {
  ...
  public static CircularAddress reinterpret$F(
    ...
    return new CircularAddress(memorySegment$f.reinterpret(MemoryLayout$F.byteSize()));
  }
  ...
  public static CircularAddress at$F(
      java.lang.foreign.MemorySegment array$f, long index$f) {
    return new CircularAddress(elementAt$F(array$f, index$f));
  }

  public final java.lang.foreign.MemorySegment MemorySegment$F;

  public CircularAddress(java.lang.foreign.SegmentAllocator allocator$f) {
    this(allocate$F(allocator$f));
  }

  public CircularAddress(java.lang.foreign.MemorySegment memorySegment$f) {
  ...
  public CircularAddress value(passmode.CircularDefault value$f) {
